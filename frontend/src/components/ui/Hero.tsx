    ...
    <section aria-label="hero">
      <FadeContainer className="relative flex flex-col items-center justify-center">
        ...
        <h1 className="mt-8 text-center text-5xl font-semibold tracking-tighter text-gray-900 sm:text-8xl sm:leading-22">
          <FadeSpan>Powering</FadeSpan> <FadeSpan>Fair EV</FadeSpan>
          <br />
          <FadeSpan>Charging for</FadeSpan> <FadeSpan>Every Community</FadeSpan>
        </h1>
        <p className="mt-5 max-w-xl text-center text-base text-balance text-gray-700 sm:mt-8 sm:text-xl">
          <FadeSpan>Revolutionizing urban mobility with intelligent load balancing, real-time grid awareness, and emergency-aware scheduling </FadeSpan>{" "}
          <FadeSpan>to make EV charging reliable, fair, and scalable.</FadeSpan>{" "}
        </p>
        <FadeDiv>
          <a
